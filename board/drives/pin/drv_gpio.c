...
static const rt_uint16_t pins[] =
{
    ...
    __STM32_PIN(81, A, 2),
#endif
#if (STM32_PIN_NUM == 100 && !defined(STM32F469xx) && !defined(STM32F479xx))
    __STM32_PIN_DEFAULT,
    __STM32_PIN(1, E, 2),
    __STM32_PIN(2, E, 3),
    __STM32_PIN(3, E, 4),

...
static const rt_uint8_t _romfs_root_z_bsp_LICENSE_txt[] = {
...
static const struct romfs_dirent _romfs_root[] = {
    ...
    {ROMFS_DIRENT_FILE, "z.bsp.LICENSE.txt", (rt_uint8_t *)_romfs_root_z_bsp_LICENSE_txt, sizeof(_romfs_root_z_bsp_LICENSE_txt)/sizeof(_romfs_root_z_bsp_LICENSE_txt[0])}
};
